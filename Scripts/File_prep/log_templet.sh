...
set SCRIPT_DIR=/project/GCRB/Hon_lab/s160875/00.Scripts/10X_genomics/barcode_extraction
set sgRNA_ref = /project/GCRB/Hon_lab/s426305/Sequencing_data_analysis/10X/YW49-YW54_10x_mapping/10x_sgRNA_RX_pipeline/YWsg1.txt
...
$SCRIPT_DIR/extract_sgRNA_from_reads.py\
...
$SCRIPT_DIR/summarize_sgRNA.ver2.py\
